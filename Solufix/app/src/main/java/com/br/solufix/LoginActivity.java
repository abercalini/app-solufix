...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            final RetrofitCondfig condfig = new RetrofitCondfig();
            Call<ResponseEntity> call = condfig.getLogin().logar(mEmailView.getText().toString(), mPasswordView.getText().toString(), "password");
            //Call<ResponseEntity> call = new RetrofitCondfig().getLogin().logar(mEmailView.getText().toString(), mPasswordView.getText().toString(), "password");
